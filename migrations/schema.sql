...
CREATE TABLE public.deployments (
    ...
    database_password character varying(255) NOT NULL,
    domain character varying(255) NOT NULL,
    external_domain character varying(255) NOT NULL,
    ...
    secret_key_base character varying(255) DEFAULT ''::character varying NOT NULL
);
